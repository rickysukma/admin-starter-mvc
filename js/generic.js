...
/*
PERHATIAN, update pada versi ini adalah errorCath() tidak lagi menggunakan kata2 error,
warning dan gagal, tetapi mengganakan ERRORCODE;
*/
...
{
	txt=txt.toUpperCase();
	if (txt.lastIndexOf('ERRORCODE') > -1)
      return false
	else
	  return true;  
}
 ...
 *******************************************************************************/
function chatPop() {
	var chatWin = getById('chatWindow');
